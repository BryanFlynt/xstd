...
inline void hash_combine(std::size_t& seed, const T& v, Rest... rest) {
	// Golden Ratio constant (Fibonacci number) used for better hash scattering
	constexpr std::size_t GOLDEN_RATIO = 0x9e3779b9;         // 32-Bit Golden Ratio
	//constexpr std::size_t GOLDEN_RATIO = 0x9e3779b97f4a7c15; // 64-Bit Golden Ratio
	//constexpr std::size_t GOLDEN_RATIO = 0x9e3779b1;         // 32-Bit Nearest Prime
	//constexpr std::size_t GOLDEN_RATIO = 0x9e3779b97f4a7c55; // 64-Bit Nearest Prime
    std::hash<T> hasher;
