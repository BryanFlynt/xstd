...
#ifndef INCLUDE_XSTD_DETAIL_FSTREAM_FORTRAN_IO_HPP_
#define INCLUDE_XSTD_DETAIL_FSTREAM_FORTRAN_IO_HPP_
...
iofort::get_record_size(){
	...
	std::cout << "RecordSize = " << value << std::endl;
	return value;
}
...
#endif /* INCLUDE_XSTD_DETAIL_FSTREAM_FORTRAN_IO_HPP_ */
